...
data = pd.read_csv('donnees_essentiel_ecobalyse.csv')  
...
train_data.to_csv('donnees_essentiel_ecobalyse_train.csv', index=False)

# Enregistrer le jeu de test dans un fichier
test_data = X_test.copy()
test_data['impact_ecs'] = y_test
test_data.to_csv('donnees_essentiel_ecobalyse_test.csv', index=False)
